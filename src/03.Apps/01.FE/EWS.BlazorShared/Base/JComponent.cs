...
public abstract class JComponent<TSelfComponent, TDlgOptions, TDlgResult> : JFeedbackComponent<TSelfComponent, TDlgOptions, TDlgResult>
where TDlgOptions : JDlgOptionsBase, new()
{
    ...
    // protected async Task ShowDialog<TComponent, TDlgOptions, TDlgResult>(TDlgOptions dlgOptions, Action<TDlgResult> action)
    //     where TComponent : FeedbackComponent<TDlgOptions, TDlgResult>
    //     where TDlgOptions : JDlgOptionsBase
    // {
    ...
    //         OnOk = e =>
    //         {
    //             Logger.LogInformation("ConfirmOptions OnOk");
    //             return Task.CompletedTask;
    //         },
    //         OnCancel = e =>
    //         {
    //             Logger.LogInformation("ConfirmOptions OnCancel");
    //             return Task.CompletedTask;
    //         },
    //     };
    ...
    //     }
    //     var confirmRef = await ModalService.CreateConfirmAsync<TComponent, TDlgOptions, TDlgResult>(options, dlgOptions);
    //     confirmRef.OnOpen = () =>
    //     {
    ...
    //     {
    //         Logger.LogInformation("OnOk Modal");
    //         action(result);
    //         return Task.CompletedTask;
    //     };
    // }
    ...
    {
#if DEBUG
        Logger.LogInformation("OnChange<T>");
#endif
